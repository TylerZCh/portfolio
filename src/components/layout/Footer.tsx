  ...
  return (
    <footer className="border-t border-neutral-100 mt-16">
      ...
      <motion.div
        ...
        className="max-w-5xl mx-auto px-6 md:px-12 lg:px-24 py-20 flex flex-col md:flex-row md:items-end justify-between gap-8"
      >
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-neutral-900 leading-tight">
            Open to new roles.
            <br />
            <span className="text-neutral-400">Say hello — I read every email.</span>
          </h2>
        </div>

        <a
          href="mailto:zeyu.cheng@outlook.com"
          className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-neutral-900 text-white text-sm font-medium hover:bg-neutral-700 transition-colors duration-200 shrink-0 group"
        >
          <Mail size={14} />
          zeyu.cheng@outlook.com
        </a>
      </motion.div>
      ...
      <div className="border-t border-neutral-100">
        <div className="max-w-5xl mx-auto px-6 md:px-12 lg:px-24 h-14 flex items-center justify-between">
          <p className="text-xs text-neutral-400">
            © {new Date().getFullYear()} Zeyu Cheng
          </p>
